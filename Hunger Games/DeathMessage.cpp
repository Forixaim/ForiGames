...
DeathMessage::DeathMessage(std::string Victim)
{
	...
	case 7:
		...
		break;
	case 8:
		MessageContent = Victim + " saw a character they simped, barked, and died because they cant get enough air to bark.";
		break;
	case 9:
	...
	case 10:
		...
		break;
	case 11:
		MessageContent = Victim + " detonated a M18 Claymore Mine";
		break;
	case 12:
